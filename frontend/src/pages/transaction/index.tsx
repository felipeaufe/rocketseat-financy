...
import { CreateTransactionDialog } from "@/pages/transaction/components/create-transaction-dialog";
import { DeleteTransactionDialog } from "@/pages/transaction/components/delete-transaction-dialog";
import { UpdateTransactionDialog } from "@/pages/transaction/components/update-transaction-dialog";
import { TransactionsTable } from "@/pages/transaction/components/transactions-table";
import { TransactionFilters } from "@/pages/transaction/components/transactions-filters";
...
export function TransactionsPage() {
  ...
  return (
    <>
      <section className="flex flex-col gap-6 items-center justify-center w-full px-12 pb-12">
